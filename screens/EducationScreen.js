...
const EducationFormSchema = yup.object({
    ...
    ChildStayType: yup.string().required(),
    Medium: yup.string().when('Class', {
        is: '22',
    ...
    SchoolType: yup.string().when('Class', {
        is: '22',
        otherwise: yup.string()
            .required(),
    }),
    SchoolPlace: yup.string().when('Class', {
        is: '22',
        otherwise: yup.string()
            .required(),
    }),
    StartingDate: yup.string().when('Class', {
        is: '22',
        otherwise: yup.string()
            .required(),
    }),
                    ...
                    <KeyboardAvoidingView behavior="null"
                        ...
                        <ScrollView showsVerticalScrollIndicator={false}>
                            ...
                            <View>
                                ...
                                {/*Child Stay Type*/}
                                <Text style={globalStyles.label}>Child Stay Type: <Text style={{ color: "red" }}>*</Text> </Text>
                                <Picker
                                ...
                                <Text style={globalStyles.errormsg}>{props.touched.ChildStayType && props.errors.ChildStayType}</Text>
                                ...
                                <Picker
                                    ...
                                    onValueChange={(itemValue, itemIndex) => {
                                        ...
                                        if (itemValue != 22) {
                                            this.setState({ showElementsclassnothing: true })
                                        } else {
                                            this.setState({ showElementsclassnothing: false })
                                        }
                                    }}
                                ...
                                {this.state.showElementsclassnothing ? <View>
